...
export const AboutComponent: FC = () => {
  return (
    <motion.section
      id="about"
      className=" bg-gradient-to-b from-[#b1c7e9] to-[#759cd8] overflow-hidden"
    ...
    >
      <div className="">
        ...
        <div className="bg-gradient-to-b from-[#edf2fa] to-[#b1c7e9] py-20">
          <div className="bg-gradient-to-b max-w-7xl mx-auto">
            <motion.div
            ...
            >
              ...
              <p className="text-lg text-gray-800 max-w-4xl mx-auto leading-relaxed mb-4 text-left">
                AGILIUM is a multidisciplinary innovation company that
                transforms ambitious visions into measurable impact. We combine
                cutting-edge technology, human-centered design, and strategic
                expertise to deliver solutions that scale and endure.
              </p>
              <p className="text-lg text-gray-800 max-w-4xl mx-auto leading-relaxed text-left">
                ...
                Strategies, we help organizations innovate, adapt, and lead in
                ...
                <Card className="h-full bg-white/70 border-blue-300 backdrop-blur-sm transition-colors duration-300 hover:border-blue-500/80">
                  <CardContent className="p-8">
                    ...
                    <p className="text-gray-800 mb-6">
                      ...
                      enterprises, and communities with innovative digital
                      solutions that bridge the physical and digital worlds. We
                      transform bold ideas into practical, measurable outcomes
                      driving efficiency, connectivity, and sustainable growth
              ...
              >
                <Card className="h-full bg-white/70 border-blue-300 backdrop-blur-sm transition-colors duration-300 hover:border-blue-500/80">
                  <CardContent className="p-8">
                    ...
                    <p className="text-gray-800 mb-6">
                      At Agilium, our vision is to shape a smarter, more
                      connected future where transformative innovation bridges
                      the digital and physical worlds. We aspire to be the
                      driving force that turns bold ideas into impactful
                      realities, inspiring progress and sustainable growth
                      across Saudi Arabia and the wider region.
                    </p>
                    <ul className="text-gray-800 space-y-2 text-left">
              ...
              >
                <Card className="h-full bg-white/70 border-blue-300 backdrop-blur-sm transition-colors duration-300 hover:border-blue-500/80">
                  <CardContent className="p-8">
                    ...
                    <p className="text-gray-800 mb-6">
                      At Agilium, our values guide every decision, partnership,
                      and solution we deliver. Rooted in innovation, integrity,
                      and collaboration, our values reflect our commitment to
                      creating measurable impact and driving excellence across
                      everything we do.
                    </p>
                ...
                <Card className="h-full bg-white/70 border-blue-300 backdrop-blur-sm transition-colors duration-300 hover:border-blue-500/80">
                  <CardContent className="p-8">
                    ...
                    <p className="text-gray-800 mb-6">
                      ...
                      transformation in Saudi Arabia and the wider GCC. Each
                      goal builds upon our mission to bridge digital and
                      physical worlds while driving intelligence, innovation,
